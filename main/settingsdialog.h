...
public: explicit SettingsDialog(QWidget *parent=nullptr);
    ...
    int wallpaperExtraFontSize() const;
    WallpaperExtraLyricsMode wallpaperExtraLyricsMode() const;
    ...
    void setWallpaperExtraFontSize(int v);
    void setWallpaperExtraLyricsMode(WallpaperExtraLyricsMode mode);
    void loadSavedFonts();
signals: void musicDirChanged( const QString &dir);
    ...
    void wallpaperExtraFontSizeChanged(int px);
...
private: void applyStyle();
    ...
    QSlider *m_wallExtraFontSlider=nullptr;
    QComboBox *m_cmbWallExtraMode=nullptr;
